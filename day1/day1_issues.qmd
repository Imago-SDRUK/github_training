...
Most important habit: **use Issues**.
...
2. Create an Issue and write down:
   - what the problem is
...
::: {.callout-tip}
Issues don’t need to be verbose. Even **one or two sentences of context** can be immensely helpful. The Pareto principle applies: 20% extra effort = 80% of the benefit!
...
Your Issue should **reference the branch you are working on**. This links two parts of our main workflow together:

> **Issue** -> Branch -> Commits -> Pull Request -> Review -> Merge

::: {.callout-tip}
GitHub will auto‑link Issues and PRs if:
...
Labels let you give an easily viewable, high level description of what the thing is you're trying to solve. For example, a `bug` label implies that your colleagues should probably take a look at your Issue, since it may affect their work. 
