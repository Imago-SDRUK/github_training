...
4. Commit that work to a [branch](day1_committing_changes.qmd)
5. Set up a [pull request](day1_pull_requests.qmd) when the work is nearing completion.
...
:::{.callout-tip}
# Issues are interactive spaces

Get involved with Issues made by other people! If you have ideas on how to implement something, questions, ideas, then write it down. 
:::
