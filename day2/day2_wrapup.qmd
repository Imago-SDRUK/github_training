...
@article{simpson2020,
  ...
  author={Simpson, Homer AND Shabadoo, Junior, Joey Jo-Jo},
  journal={Nature},
  year={2020}
}
```
...
- Don't worry about perfection straight away. Issues are where all your messy ideas can live. Worry about polish just before you're ready to merge it in. 
...
- Reach out to me if you have questions. Chances are it will save you trawling through StackOverflow. 

- ***Don't worry if you don't follow all of the guidelines all of the time***! The intent is to improve the way we work, not to enforce orthodoxy for its own sake. That said, do try and use them as much as you can! 
